...
$$
    BEGIN
        IF NOT EXISTS(SELECT 1 FROM pg_tables WHERE tablename = 'tb_veicle') THEN
            ...
            (
              veicle_id          								UUID PRIMARY KEY DEFAULT gen_random_uuid(),
							...
							day4 															VARCHAR(10) NULL DEFAULT NULL,
							day5 															VARCHAR(10) NULL DEFAULT NULL,
							day6 															VARCHAR(10) NULL DEFAULT NULL,
							day7 															VARCHAR(10) NULL DEFAULT NULL,
